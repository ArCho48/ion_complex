    ...
    for file_name in os.listdir(model_checkpoint_dir):
        ...
        with torch.no_grad():
            ...
            for batch in val_loader:
                ...
                batch_y_pred.append(model(batch).detach().cpu().numpy())
...
if __name__ == "__main__":
    ...
    selected_predictors_job_ids, selected_predictors_weights = create_gcn_ensemble(
        hpo_results, model_checkpoint_dir, num_node_features, val_data, sys.argv[1], k
    )
