...
from Training_rf_mse import dense_and_concat


def create_rf_ensemble(
...
if __name__ == "__main__":
    ...
    ) = create_rf_ensemble(model_checkpoint_dir, val_data, val_labels, sys.argv[1], k)
    ...
    ax.set_title('RF Ensemble ('+ sys.argv[1] +') Predictions',fontsize=17)
    ax.legend(fontsize=13)
    ax.grid(True)
    plt.tight_layout()
    name = 'fig1' if sys.argv[1] == 'greedy' else 'fig2'
    plt.savefig("../results/rf/"+name+".png")
